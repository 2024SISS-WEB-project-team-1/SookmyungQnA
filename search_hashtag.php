...
//각 변수에 index.php로부터 input name값들을 저장
$hashtag = $_GET['tag'];
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <!-- Featured blog post-->
                    <h1>카테고리 - '<?php echo $hashtag; ?>' 검색결과</h1>
                            ...
                            <table> 
                                ...
                                <?php
                                    // question 테이블에서 id를 기준으로 10개까지 표시
                                      $sql = "SELECT * FROM question WHERE hashtag = '$hashtag' order by id desc"; 
                                      // $sql = "SELECT * FROM question WHERE hashtag = '$hashtag'";
