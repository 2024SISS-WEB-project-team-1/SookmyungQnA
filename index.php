                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="search.php" method="get" class="input-group">
                                ...
                                <input class="form-control" name="keyword" type="text" placeholder="검색어를 입력하세요.." aria-label="검색어를 입력하세요.." aria-describedby="button-search" />
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul class="list-unstyled mb-0">
                                        <li><a href="search_hashtag.php?tag=<?php echo urlencode('교내생활'); ?>">#교내생활</a></li>
                                        <li><a href="search_hashtag.php?tag=<?php echo urlencode('전공'); ?>">#전공</a></li>
                                        <li><a href="search_hashtag.php?tag=<?php echo urlencode('진로'); ?>">#진로</a></li>
                                    </ul>
                                </div>
                                <div class="col-sm-6">
                                    <ul class="list-unstyled mb-0">
                                        <li><a href="search_hashtag.php?tag=<?php echo urlencode('학식'); ?>">#학식</a></li>
                                        <li><a href="search_hashtag.php?tag=<?php echo urlencode('학사/행정'); ?>">#학사/행정</a></li>
                                        <li><a href="search_hashtag.php?tag=<?php echo urlencode('수업'); ?>">#수업</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
